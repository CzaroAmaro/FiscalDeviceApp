# Generated by Django 5.2 on 2025-10-28 17:02
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('user', models.OneToOneField(on_delete=django.db.models.deletion.CASCADE, related_name='technician_profile', to=settings.AUTH_USER_MODEL, verbose_name='Użytkownik')),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('status', models.CharField(choices=[('open', 'Otwarte'), ('in_progress', 'W toku'), ('closed', 'Zamknięte')], db_index=True, default='open', max_length=20)),
        ...
        migrations.CreateModel(
            ...
            options={
                ...
                'constraints': [models.UniqueConstraint(fields=('technician', 'manufacturer'), name='unique_technician_manufacturer_certification')],
            },
        ),
    ]
